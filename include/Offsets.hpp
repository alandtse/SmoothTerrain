 ...
 *
 * @return bool True on SE (1.5.x) and AE (1.6.x), the flavors whose IDs are verified
 */
[[nodiscard]] inline auto isRuntimeSupported() -> bool { return REL::Module::IsSE() || REL::Module::IsAE(); }
 ...
 * 1.5.97: 0x25CBA0. 1.6.1170: 0x2AF3A0.
 */
 ...
 *
 * AE calls BuildQuadTriShape from here directly (its second call site); SE has no direct call
 * and reaches the builder through K_BUILD_LAND_QUADS instead, so there is nothing to patch
 * here on SE. 1.5.97: 0x2567F0. 1.6.1170: 0x2A8B00.
 */
 ...
 * shapes, no collision). Holds a call site to BuildQuadTriShape on both flavors - the only one
 * on SE, where K_BUILD_LAND_GEOMETRY calls this instead of the builder.
 * 1.5.97: 0x25B710. 1.6.1170: 0x2ADBC0.
 */
 ...
 * whenever it has to walk the triangles of a landscape material. Both flavors are the same two
 * instructions (load the global, return) with exactly one caller in the whole executable.
 * 1.5.97: 0x25A7C0. 1.6.1170: 0x2ACAC0.
 */
 ...
 * 1.5.97: 0x44F6F0. 1.6.1170: 0x4ABD70.
 */
 ...
 * 1.5.97: 0x44DBF0. 1.6.1170: 0x4A9C70.
 */
 ...
 * 1.5.97: 0x44F6B0. 1.6.1170: 0x4ABD30.
 */
 ...
 * 1.5.97: 0x30136C0. 1.6.1170: 0x3274040.
 */
